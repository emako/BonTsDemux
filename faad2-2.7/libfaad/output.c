                         ...
                         int16_t **sample_buffer)
{
    ...
    case CONV(1,1):
        for(i = 0; i < frame_len; i++)
        {
            ...
            (*sample_buffer)[i] = (int16_t)lrintf2(inp);
        }
        break;
    case CONV(2,0):
        if (hDecoder->upMatrix)
        {
            ...
            for(i = 0; i < frame_len; i++)
            {
                ...
                (*sample_buffer)[(i*2)+0] = (int16_t)lrintf2(inp0);
                (*sample_buffer)[(i*2)+1] = (int16_t)lrintf2(inp0);
            }
        } else {
            ch  = hDecoder->internal_channel[0];
            ...
            for(i = 0; i < frame_len; i++)
            {
                ...
                (*sample_buffer)[(i*2)+0] = (int16_t)lrintf2(inp0);
                (*sample_buffer)[(i*2)+1] = (int16_t)lrintf2(inp1);
            }
        }
        break;
    default:
        for (ch = 0; ch < channels; ch++)
        {
            for(i = 0; i < frame_len; i++)
            {
                ...
                (*sample_buffer)[(i*channels)+ch] = (int16_t)lrintf2(inp);
            }
        }
        break;
    }
                         ...
                         int32_t **sample_buffer)
{
    ...
    case CONV(1,1):
        for(i = 0; i < frame_len; i++)
        {
            ...
            (*sample_buffer)[i] = (int32_t)lrintf2(inp);
        }
        break;
    case CONV(2,0):
        if (hDecoder->upMatrix)
        {
            ...
            for(i = 0; i < frame_len; i++)
            {
                ...
                (*sample_buffer)[(i*2)+0] = (int32_t)lrintf2(inp0);
                (*sample_buffer)[(i*2)+1] = (int32_t)lrintf2(inp0);
            }
        } else {
            ch  = hDecoder->internal_channel[0];
            ch1 = hDecoder->internal_channel[1];
            for(i = 0; i < frame_len; i++)
            {
                ...
                (*sample_buffer)[(i*2)+0] = (int32_t)lrintf2(inp0);
                (*sample_buffer)[(i*2)+1] = (int32_t)lrintf2(inp1);
            }
        }
        break;
    default:
        for (ch = 0; ch < channels; ch++)
        {
            for(i = 0; i < frame_len; i++)
            {
                ...
                (*sample_buffer)[(i*channels)+ch] = (int32_t)lrintf2(inp);
            }
        }
        break;
    }
